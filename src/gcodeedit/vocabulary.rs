...
pub static G_CODES: &[CodeInfo] = &[
    CodeInfo {
        ...
        supported_in: &["1.0", "1.1", "1.2"],
    },
    CodeInfo {
        code: "G1",
        description: "Linear interpolation (feed)",
        supported_in: &["1.0", "1.1", "1.2"],
    },
    CodeInfo {
        code: "G2",
    ...
    CodeInfo {
        code: "G10",
        description: "Coordinate data/probe (controller dependent)",
        supported_in: &["1.1", "1.2"],
    },
    CodeInfo {
        code: "G17",
    ...
    CodeInfo {
        code: "G20",
        description: "Units: inches",
        supported_in: &["1.0", "1.1", "1.2"],
    },
    CodeInfo {
        code: "G21",
        description: "Units: millimeters",
        supported_in: &["1.0", "1.1", "1.2"],
    },
    CodeInfo {
        code: "G28",
    ...
    CodeInfo {
        code: "G30",
        description: "Return to secondary home",
        supported_in: &["1.0", "1.1", "1.2"],
    },
    CodeInfo {
        code: "G38.2",
        description: "Probe toward workpiece (stop on contact)",
        supported_in: &["1.1", "1.2"],
    },
    CodeInfo {
        code: "G40",
        description: "Tool radius compensation off (limited support)",
        supported_in: &["1.1", "1.2"],
    },
    CodeInfo {
        code: "G53",
        description: "Machine coordinate system (non-modal)",
        supported_in: &["1.1", "1.2"],
    },
    CodeInfo {
        code: "G54",
...
pub static M_CODES: &[CodeInfo] = &[
    ...
    CodeInfo {
        code: "M7",
        description: "Mist coolant on (if supported)",
        supported_in: &["1.1", "1.2"],
    },
    CodeInfo {
        code: "M8",
    ...
    CodeInfo {
        code: "M30",
        description: "Program end and reset",
        supported_in: &["1.0", "1.1", "1.2"],
    },
];
