...
impl FirmwareManager {
    ...
    pub fn check_for_updates(&mut self, firmware_type: &FirmwareType) -> Result<Vec<FirmwareRelease>, String> {
    ...
    pub fn flash_firmware(&self, firmware_path: &PathBuf, controller_type: &FirmwareType) -> Result<(), String> {
    ...
    pub fn validate_firmware_compatibility(&self, firmware: &FirmwareVersion, controller_type: &FirmwareType) -> bool {
