...
impl DesignerState {
    ...
    pub fn export_to_obj(&self) -> Result<String> {
        ...
        if obj_content.is_empty() {
            // Provide a minimal OBJ header for empty designs to satisfy export consumers/tests
            obj_content.push_str("# Empty OBJ generated by gcodekit\n");
        }
        Ok(obj_content)
    }
                    ...
                    if canvas_response.clicked() {
                        ...
                        match self.current_tool {
                            DrawingTool::Select => {
                                ...
                                if self.selected_point.is_some() && canvas_response.dragged() {
